	...
	var BraintreeService = (function () {
	   ...
	   */
			...
			value: function getCustomer(customerId) {
				...
				var path = this._apiUrl + this._customerPath + '/' + customerId;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var component = {
		bindings: {},
		template: _subscriptionHtml2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubscriptionOverviewComponent = (function () {
		function SubscriptionOverviewComponent(braintreeDataService) {
		...
		_createClass(SubscriptionOverviewComponent, [{
			...
			value: function _confirmSubscription() {
				...
				this.braintreeDataService.createSubscription(subscriptionData).then(function (response) {
					if (response.data.success) {
						_this.message = 'Subscription was created!';
						_this.state.loading = false;
		...
		SubscriptionOverviewComponent = Inject('braintreeDataService')(SubscriptionOverviewComponent) || SubscriptionOverviewComponent;
